...
APP_INTENT = Config.APP_INTENTBOT_USERNAME = Config.BOT_USERNAME
...
def grphelp(m):
    ghelpstr = f"""*Available Commands in Group :*
        \n/rebuild - *To Rebuild the Latest Movies of VTube App*
        \n/find - *To Search in VTube App and Get Movie/Series Links.*
        \n/search - *To Search in VTube App and Get Movie/Series Including Episode Links.*
        """
